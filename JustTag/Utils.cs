...
namespace JustTag
{
    public static class Utils
    {
        ...
        public static void WriteConsole(string txt, bool isError = false)
        {
            Pages.MainWindow.WriteConsole(txt, isError);
        }
        ...
        /// <summary>
        /// Returns if the given file is a video
        /// Just does a naive check of the file extention :(
        /// </summary>
        /// <param name="filePath"></param>
        /// <returns></returns>
        ...
        public static void WriteFileLog(string Type, string fileFullPath)
        {
            ...
            if(Type == "delete")
            {
                System.IO.File.AppendAllText("log.txt", "Deleted file: " + fileFullPath + " on " + DateTime.Now.ToString() + "\n");
            }
            if (Type == "create")
            {
                System.IO.File.AppendAllText("log.txt", "Created file: " + fileFullPath + " on " + DateTime.Now.ToString() + "\n");
            }
            if (Type == "rename")
            {
                System.IO.File.AppendAllText("log.txt", "Renamed file: " + fileFullPath + " on " + DateTime.Now.ToString() + "\n");
            }
        }
